    ...
    <>
      <section className="bg-midnight">
        <div className="container py-20 max-w-3xl">
          <span className="eyebrow">About Jall Technologies</span>
          <h1 className="text-white mb-6">Software built with intent, not shortcuts</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {values.map((v) => (
              <div key={v.name} className="card p-6">
                <v.icon className="text-midnight mb-3" size={24} />
                <h4 className="mb-1.5">{v.name}</h4>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <span key={tag} className="badge bg-gray-light text-gray-dark">
                  {tag}
                </span>
              ))}
            </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <div
                  key={tech}
                  className="text-sm font-mono bg-midnight text-white/90 rounded-md px-3 py-2 text-center"
                >
                  {tech}
                </div>
              ))}
